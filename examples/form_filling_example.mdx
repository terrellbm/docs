...
### Overview
This guide walks you through an example of using **Spongecake** to fill out a form.
...
- When filling out a form its best to give the agent exactly what fields need to be filled out and how
    - The less reasoning the agent does, the better the performance will be
    - For example, you could have one agent parse a document and reason over different fields to calculate what needs to be filled out. Then, the desktop agent just goes and fills in the values